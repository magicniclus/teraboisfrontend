...
const Condition = () => {
    return (
        <>
            <header className='politiqueHeader'>
                <HomeNavigation />
            </header>
...
Ce site web est exploité par TeraBois. Sur ce site, les termes "nous", "notre" et "nos" font référence à TeraBois. TeraBois propose ce site web, y compris toutes les informations, tous les outils et tous les services qui y sont disponibles pour vous, l’utilisateur, sous réserve de votre acceptation de l’ensemble des modalités, conditions, politiques et avis énoncés ici.
...
Ces Conditions Générales de Vente et d’Utilisation, ainsi que tout autre accord séparé par le biais duquel nous vous fournissons des Services seront régis et interprétés en vertu des lois en vigueur à 36 avenue francois mitterrand, Floirac, B, 33270, France.
...
Les questions concernant les Conditions Générales de Vente et d’Utilisation devraient nous être envoyées à eleadbase@gmail.com.
