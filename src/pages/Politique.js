        ...
        <>
            ...
            <main className='politique'>
                ...
                <section>
                    ...
                    <p>Notre boutique est hébergée sur AWS. Ils nous fournissent la plate-forme e-commerce en ligne qui nous permet de vous vendre nos services et produits.

                    Vos données sont stockées dans le système de stockage de données et les bases de données de AWS, et dans l’application générale de AWS. Vos données sont conservées sur un serveur sécurisé protégé par un pare-feu.</p>
                    ...
                    <h3>36 avenue francois mitterrand, Floirac, B, 33270, France</h3>
                </section>
            </main>
        </>
    );
