            ...
            <main className="homePage">
                ...
                <div className="containerTop">
                    ...
                    <section className="specialiste">
                        <ImageAndText addClass="imageAndText" sens="left" folder="multitmaison" img="multitmaison" alt="isolation interieur" title="Spécialiste de l’économie d’énergie " text="TeraBois, spécialiste en économie d'énergie de l'habitat depuis plus de 10 ans, TeraBois est avant tout une entreprise familiale et artisanale." textTwo="Notre savoir faire nous a permis de nous positionner comme l'entreprise leader dans son domaine." />
                    </section>
