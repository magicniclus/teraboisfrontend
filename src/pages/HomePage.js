    ...
    <>
      ...
      <main className="homePage">
        ...
        <div className="containerTop">
          ...
          <TitleAndText
            title="Maison TeraBois"
            text="“Notre savoir-faire au service de votre bien-être”"
            prestation={[
              "Isolation des combles",
              "Isolation sous rampant",
              "Isolation murs interieurs",
              "Isolation murs exterieurs",
            ]}
            img="./img/test/house/maisonbois.jpg"
            susTitle="Entreprise Qualibat RGE"
          />
          ...
          <section className="specialiste">
            <ImageAndText
              addClass="imageAndText"
              sens="left"
              folder="multitmaison"
              img="multitmaison"
              alt="isolation interieur"
              title="Spécialiste de l’économie d’énergie "
              text="TeraBois, spécialiste en économie d'énergie de l'habitat depuis plus de 10 ans, TeraBois est avant tout une entreprise familiale et artisanale."
              textTwo="Notre savoir faire nous a permis de nous positionner comme l'entreprise leader dans son domaine."
            />
          </section>
          <NavLink to="/about" className="btnUn">
            En savoir plus
          </NavLink>
        </div>
        <section className="smallBottomContainer">
          <DropDown
            ...
            text="Facture réduite,
                                        Gain en confort,
                                        Maison plus saine,
                                        Participation à l'effort écologique,
        ...
        <section className="bottomContainer">
          <h2 className="bottomContainerTitle">
            Pourquoi bien faire isoler son logement ?
          </h2>
          <div className="avantageContainer">
            <div className="aidesContainer">
              <h3 className="aides">
                Jusqu'à <br /> 50 000€ d'aîde
              </h3>
            </div>
            ...
            <div className="endContainer">
              <NavLink to="/nous-contacter" className="btnUn">
                Isoler mon <br />
                logement
              </NavLink>
            </div>
          ...
          <div className="garantiesContainer">
            ...
            <div className="garanties">
              ...
              <p>
                Devis gratuit <br /> en 24/48h
              </p>
            </div>
            <div className="garanties">
              <img src="./img/SVG/1x/feather.png" alt="hand" />
              <p>
                Données 100% <br /> sécurisées
              </p>
            </div>
            <div className="garanties">
